...
function render(l){lang=l;localStorage.setItem('siteLang',l);const c=window.SITE_CONTENT[l];document.documentElement.lang=l;document.title=c.pageTitle;const meta=$('[name=description]');if(meta)meta.content=c.metaDescription;
